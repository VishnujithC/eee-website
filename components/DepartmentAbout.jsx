        ...
        <section className={styles.wrapper}>
            <div className={styles.content}>
                ...
                <div className={styles.info}>
                    <p>
                        The Department Library of Electrical & Electronics Engineering is a valuable resource
                        for students, faculty, and researchers in the Electrical & Electronics Engineering
